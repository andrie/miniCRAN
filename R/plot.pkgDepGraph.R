...
#' @param shape Shape of edge.  See \code{\link{igraph.plotting}}. Could be "none", "circle", "square", ...
#' @param vertex.size Size of vertex shape. See \code{\link{igraph.plotting}}
